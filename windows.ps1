...
# Set Computer Name
(Get-WmiObject Win32_ComputerSystem).Rename("OPTIMUS") | Out-Null
...
# Get-AppXProvisionedPackage -Online | Where-Object DisplayName -like "Microsoft.3DBuilder" | Remove-AppxProvisionedPackage -Online
...
# Get-AppXProvisionedPackage -Online | Where-Object DisplayName -like "*.AutodeskSketchBook" | Remove-AppxProvisionedPackage -Online

# # Uninstall Bing Finance
# Get-AppxPackage "Microsoft.BingFinance" -AllUsers | Remove-AppxPackage
# Get-AppXProvisionedPackage -Online | Where-Object DisplayName -like "Microsoft.BingFinance" | Remove-AppxProvisionedPackage -Online
...
# Get-AppXProvisionedPackage -Online | Where-Object DisplayName -like "Microsoft.BingSports" | Remove-AppxProvisionedPackage -Online
...
# Get-AppXProvisionedPackage -Online | Where-Object DisplayName -like "king.com.BubbleWitch3Saga" | Remove-AppxProvisionedPackage -Online
...
# Get-AppXProvisionedPackage -Online | Where-Object DisplayName -like "king.com.CandyCrushSodaSaga" | Remove-AppxProvisionedPackage -Online

# # Uninstall Disney Magic Kingdoms
# Get-AppxPackage "*.DisneyMagicKingdoms" -AllUsers | Remove-AppxPackage
# Get-AppXProvisionedPackage -Online | Where-Object DisplayName -like "*.DisneyMagicKingdoms" | Remove-AppxProvisionedPackage -Online

# # Uninstall Dolby
# Get-AppxPackage "DolbyLaboratories.DolbyAccess" -AllUsers | Remove-AppxPackage
# Get-AppXProvisionedPackage -Online | Where-Object DisplayName -like "DolbyLaboratories.DolbyAccess" | Remove-AppxProvisionedPackage -Online
...
# Get-AppXProvisionedPackage -Online | Where-Object DisplayName -like "*.MarchofEmpires" | Remove-AppxProvisionedPackage -Online
...
# Get-AppXProvisionedPackage -Online | Where-Object DisplayName -like "Microsoft.Office.OneNote" | Remove-AppxProvisionedPackage -Online
...
# Get-AppXProvisionedPackage -Online | Where-Object DisplayName -like "*.SlingTV" | Remove-AppxProvisionedPackage -Online
...
# Get-AppXProvisionedPackage -Online | Where-Object DisplayName -like "SpotifyAB.SpotifyMusic" | Remove-AppxProvisionedPackage -Online
...
# Get-AppXProvisionedPackage -Online | Where-Object DisplayName -like "Microsoft.WindowsPhone" | Remove-AppxProvisionedPackage -Online
...
# Set-ItemProperty $(Join-Path $diskCleanupRegPath "Delivery Optimization Files"                  ) "StateFlags6174" 2   -ErrorAction SilentlyContinue
...
Write-Host "Done. Note that some of these changes require a logout/restart to take effect." -ForegroundColor "Yellow"
